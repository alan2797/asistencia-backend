...
class DAlumno {
    ...
    function registrarAlumnoD(){
         $sql = "INSERT INTO alumno(nombre, apellido, ci, telefono, estado)
                VALUES(?, ?, ?, ?, ?);";
        $stmt = Conexion::conectar()->prepare($sql);
    ...
    function eliminarAlumnoD(){
        $sql = "update alumno set estado = '0' where id = ?;";
        $stmt = Conexion::conectar()->prepare($sql);
